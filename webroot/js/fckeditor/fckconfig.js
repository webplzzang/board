...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Image','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','TextColor','BGColor','FontName','FontSize','-','About']
] ;

FCKConfig.ToolbarSets["Simple"] = [
	['Bold','Italic','-','Link','Unlink','TextColor','BGColor','FontName','FontSize','-','About']
] ;
